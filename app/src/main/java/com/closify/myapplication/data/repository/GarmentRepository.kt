...
class GarmentRepository {
    ...
    companion object {
        ...
        private val ZAPATOS_ELEG_2    = res("zapatos_elegantes_2")

        // ── Placeholders (sin imagen real todavía) ────────────────────────────
        private val TOP       = res("ic_garment_top")
        private val BOTTOM    = res("ic_garment_bottom")
        private val FOOTWEAR  = res("ic_garment_footwear")
        private val OUTERWEAR = res("ic_garment_outerwear")
        private val DRESS     = res("ic_garment_dress")
    ...
    private val garments = listOf(
        ...
        Garment(
            ...
            category = GarmentCategory.BOTTOM, color = GarmentColor.BEIGE,
            imageUrl = BOTTOM,                                               // sin imagen real
            suitableWeather = setOf(WeatherCondition.MILD, WeatherCondition.ANY),
        ...
        Garment(
            ...
            imageUrl = OUTERWEAR,                                            // sin imagen real
        ...
        Garment(
            ...
            imageUrl = DRESS,                                                // sin imagen real
